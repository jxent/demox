...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public static DiskLruCache create(FileSystem fileSystem, File directory, int appVersion, int
        ...
        Executor executor = new ThreadPoolExecutor(0, 1, 60L, TimeUnit.SECONDS, new
    ...
    private void readJournal() throws IOException {
        ...
        try {
            ...
            if (!MAGIC.equals(magic) || !VERSION_1.equals(version) || !Integer.toString
                    (appVersion).equals(appVersionString) || !Integer.toString(valueCount).equals
    ...
    boolean journalRebuildRequired() {
        ...
        return redundantOpCount >= redundantOpCompactThreshold && redundantOpCount >= lruEntries
                .size();
    }
